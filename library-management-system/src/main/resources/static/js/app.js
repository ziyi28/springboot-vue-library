...
function updateNavigationForRole(role) {
    ...
    if (role === 'ADMIN' || role === 'admin' || role === 'LIBRARIAN') {
        ...
        sidebarUserRegistration.style.display = 'block';
        sidebarUserList.style.display = 'block';
        sidebarAddBook.style.display = 'block';
        sidebarBookList.style.display = 'block';
        navBookManagement.style.display = 'block';
        console.log('显示管理员功能');
    } else {
