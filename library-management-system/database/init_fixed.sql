...
ALTER TABLE `book_records` ADD CONSTRAINT `fk_book_records_book`
  FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE CASCADE;

ALTER TABLE `borrow_records` ADD CONSTRAINT `fk_borrow_records_user`
  FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE RESTRICT;

ALTER TABLE `borrow_records` ADD CONSTRAINT `fk_borrow_records_book`
  FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE RESTRICT;

ALTER TABLE `borrow_records` ADD CONSTRAINT `fk_borrow_records_book_record`
  FOREIGN KEY (`book_record_id`) REFERENCES `book_records` (`id`) ON DELETE RESTRICT;

ALTER TABLE `borrow_records` ADD CONSTRAINT `fk_borrow_records_admin`
  FOREIGN KEY (`admin_id`) REFERENCES `admins` (`id`) ON DELETE SET NULL;

ALTER TABLE `favorites` ADD CONSTRAINT `fk_favorites_user`
  FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

ALTER TABLE `favorites` ADD CONSTRAINT `fk_favorites_book`
  FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE CASCADE;
...
-- 创建一些图书副本记录
INSERT INTO `book_records` (`book_id`, `barcode`, `location`, `status`) VALUES
(1, 'ISBN9787111213826-001', 'A区1排1架', 1),
(1, 'ISBN9787111213826-002', 'A区1排1架', 1),
(1, 'ISBN9787111213826-003', 'A区1排1架', 1),
(2, 'ISBN9787020002207-001', 'B区2排3架', 1),
(2, 'ISBN9787020002207-002', 'B区2排3架', 1),
(3, 'ISBN9787508647357-001', 'C区3排2架', 1),
(4, 'ISBN9787020002208-001', 'B区2排4架', 1),
(5, 'ISBN9787111407010-001', 'A区1排2架', 1),
(5, 'ISBN9787111407010-002', 'A区1排2架', 1),
(5, 'ISBN9787111407010-003', 'A区1排2架', 1);

-- 验证创建结果
SELECT 'Database tables created successfully' as message;
SHOW TABLES;
SELECT COUNT(*) as admin_count FROM admins;
SELECT COUNT(*) as category_count FROM book_categories;
SELECT COUNT(*) as book_count FROM books;
SELECT COUNT(*) as book_record_count FROM book_records;